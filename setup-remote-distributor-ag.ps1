...
[string]$DistributorPrimary = 'sqltest3A\DS1'
[string]$DistributorSecondary = 'sqltest3B\DRDS1'
[string]$DistributionDb = 'DistributionDB'
[string]$DistributionAgName = 'Dist_AG'
[string]$DistributorListener = 'dbtest3ds1ag1agl1'
[string]$DistributorListenerIp = '10.228.64.6'
