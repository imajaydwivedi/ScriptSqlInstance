...
#Parameters
[string]$Path = 'C:\Users\Public\Documents\Logs\Sql2019Upgrade\'
[string]$Distributor = 'dbtest3ds1ag1agl1'
[string]$Publisher = 'sqltest2ds2ag2'
[string]$Subscriber = 'sqltest2ds2ag3'
[string]$DistributionDb = 'DistributionDB'
[string]$PublisherDb = 'DbaReplPub13'
[string]$SubscriberDb = 'DbaReplSub13'
[string]$ReplWorkingDirectory = '\\sqltest3a\ag_share\'
...
EXEC sp_adddistributor @distributor = N'$( if($isDistributorAg){$distributorListener}else{$distributorSqlInstance} )',
                       @password = N'P0ssw@rd1'; /* distributor_admin password used in distributor linked server RPC connection */
GO
...
<#
$primaryReplica = 'sqltest3a\ds1'
$drReplica = 'sqltest3b\drds1'
